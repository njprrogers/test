...
export default class Items extends Client {
  ...
  get(organization, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/catalog/items`,
      options
    );
  }
  ...
  getVersions(organization, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/catalog/items/versions`,
      options
    );
  }
  ...
  getByNumber(organization, number, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/catalog/items/${number}`,
      options
    );
  }
  ...
  putPriceByNumber(organization, number, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/catalog/items/${number}/price`,
      {
        ...options,
        method: "PUT"
      }
