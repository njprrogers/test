...
export default class Serials extends Client {
  ...
  get(organization, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/inventory/serials`,
      options
    );
  }
  ...
  getPricesByAggregate(organization, aggregate, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/inventory/serials/prices/${aggregate}`,
      options
    );
  }
  ...
  getVersions(organization, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/inventory/serials/versions`,
      options
    );
  }
  ...
  getByNumber(organization, number, options = {}) {
    return this.makeRequest(
      `${this.host}/${organization}/inventory/serials/${number}`,
      options
    );
  }
